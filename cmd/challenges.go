...
var challenges = map[string]interface{}{
	...
	"Unique ID Generation": []string{"-w", "unique-ids", "--bin", "./challenges/go-gossip-gloomers", "--time-limit", "30", "--rate", "1000", "--node-count", "3", "--availability", "total", "--nemesis", "partition"},
	...
	"Grow-Only Counter": []string{"-w", "g-counter", "--bin", "./challenges/go-gossip-gloomers", "--node-count", "3", "--rate", "100", "--time-limit", "20", "--nemesis", "partition"},
	"Kafka-Style Log":   []string{"-w", "kafka", "--bin", "./challenges/go-gossip-gloomers", "--node-count", "1", "--concurrency", "2n", "--time-limit", "20", "--rate", "1000"},
